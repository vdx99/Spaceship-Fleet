...
The project includes autogenerated API documentation using springdoc-openapi and Swagger UI.

Once the backend is running, the Swagger UI is available at:

- http://localhost:8080/swagger-ui/index.html

From there you can explore the available endpoints, inspect request/response models and try out the API directly from the browser.
