...
- Add update and delete operations for spaceships on both API and UI level
- Implement sorting and more advanced filtering options on the list view
- Add authentication/authorization with role‑based access
- Extend metrics with more detailed statistics (per endpoint, per status code, etc.)
- Add unit and integration tests for core business logic and REST endpoints
